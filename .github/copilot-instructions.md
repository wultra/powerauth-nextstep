# Copilot Instructions — powerauth-nextstep

This file captures conventions used when working with GitHub Copilot in the `powerauth-nextstep`
...
## [Unreleased]
### Added
- New feature description [(#N)](https://github.com/wultra/powerauth-nextstep/issues/N)
...
[unreleased]: https://github.com/wultra/powerauth-nextstep/compare/1.2.3...HEAD
[1.2.3]: https://github.com/wultra/powerauth-nextstep/compare/1.2.2...1.2.3
```
...
- Each entry: `- <Description starting with verb> [(#N)](https://github.com/wultra/powerauth-nextstep/issues/N)` — link to the issue, not the PR.
